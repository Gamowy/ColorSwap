...
ObstacleSquare::ObstacleSquare(float yPosition, Texture& starTexture, Texture& colorSwitchTexture) : Obstacle(yPosition, starTexture, colorSwitchTexture)
{
	...
	rectangles[0].rotate(90.f);
	rectangles[0].setPosition(center.x, center.y);
	...
	rectangles[1].setPosition(center.x, center.y);
	...
	rectangles[2].setPosition(center.x, center.y);
	...
	rectangles[3].setPosition(center.x, center.y);
	rectangles[3].rotate(90.f);
